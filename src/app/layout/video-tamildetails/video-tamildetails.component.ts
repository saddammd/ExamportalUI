...
export class VideoTamildetailsComponent {
  ...
  loadVideoDetails(){
    this.route.queryParams.subscribe((params) => {
      if (params[`data`]) {
        ...
        this.videoUrl =  this.lesson.video[0].url;
        }
        else{
